...
public class ClientConfig {
    ...
    public static final ModConfigSpec.IntValue HUD_PADDING;
    public static final ModConfigSpec.IntValue HUD_DYNAMIC_MAX_DISPLAY_COUNT;
    public static final ModConfigSpec.DoubleValue HUD_LAYOUT_RELATIVE_X;
    public static final ModConfigSpec.DoubleValue HUD_LAYOUT_RELATIVE_Y;
    public static final ModConfigSpec.IntValue HUD_LAYOUT_SPACING;
    public static final ModConfigSpec.DoubleValue HUD_LAYOUT_MAX_SCREEN_HEIGHT_RATIO;
    ...
    // 灼烧
    public static final ModConfigSpec.ConfigValue<String> SCORCH_COLOR_TEXT;
    public static final ModConfigSpec.ConfigValue<String> SCORCH_COLOR_BACKGROUND;

    // 舒张
    public static final ModConfigSpec.ConfigValue<String> DIASTOLE_COLOR_TEXT;
    public static final ModConfigSpec.ConfigValue<String> DIASTOLE_COLOR_BACKGROUND;
