...
public class ClientConfig {
    ...
    public static final ModConfigSpec.IntValue SCORCH_DISPLAY_X;
    public static final ModConfigSpec.IntValue SCORCH_DISPLAY_Y;
    public static final ModConfigSpec.IntValue SCORCH_PADDING;
