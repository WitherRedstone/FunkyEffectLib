...
public class Overshield extends MobEffect {
    ...
    public void removeAttributeModifiers(LivingEntity entity, AttributeMap attributeMap, int amplifier) {
        // 计算该效果提供的总吸收生命值并扣除
        float absorptionToRemove = ABSORPTION_PER_LEVEL * (amplifier + 1);
        entity.setAbsorptionAmount(entity.getAbsorptionAmount() - absorptionToRemove);
        // 调用父类方法，移除属性修饰符
